...
<div class="main-content">
    ...
    <div class="page-container">
        ...
        <div class="stats-row">
            <a href="laporan.php" class="stat-card" style="cursor:pointer;text-decoration:none" data-tooltip="Pergi ke halaman Laporan Inventaris">
...
(function(){
    ...
    function loadDashboardStats() {
        ...
        fetch('../admin/api_barang.php?action=stats&time_filter=' + timeFilter)
            .then(r => r.json())
            .then(res => {
                if(res.success){
                    ...
                    anim(document.getElementById('statHabis'), res.habis);
    ...
    fetch('../admin/api_barang.php?action=chart_data')
        .then(r => r.json())
        .then(res => {
            if (res.success) {
